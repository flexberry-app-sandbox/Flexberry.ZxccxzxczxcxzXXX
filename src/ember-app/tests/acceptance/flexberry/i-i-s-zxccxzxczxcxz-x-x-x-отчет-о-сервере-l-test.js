...
moduleForAcceptance('[AGAT] Acceptance | i i s zxccxzxczxcxz x x x отчет о сервере l');

test('testing i-i-s-zxccxzxczxcxz-x-x-x-отчет-о-сервере-l', function(assert) {
